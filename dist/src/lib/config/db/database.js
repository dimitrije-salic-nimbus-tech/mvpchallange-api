...
exports.closeConnection = exports.configureDatabase = void 0;
...
var closeConnection = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        connection === null || connection === void 0 ? void 0 : connection.close().then(function () { return Promise.resolve(); });
        return [2 /*return*/];
    });
}); };
