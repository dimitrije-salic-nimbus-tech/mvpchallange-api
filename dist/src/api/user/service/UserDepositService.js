...
var changeDeposit = function (id, request) { return __awaiter(void 0, void 0, void 0, function () {
    var userRepository, user, deposit;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, userRepository.update(id, { deposit: deposit }).then(function () { return deposit.toString(); })];
        }
    });
}); };
var resetDeposit = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, userRepository.update(id, { deposit: 0 }).then(function () { return Promise.resolve(); })];
        }
    });
}); };
